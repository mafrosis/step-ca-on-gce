...
RUN curl -o /tmp/step.tgz -L https://github.com/smallstep/certificates/releases/download/v${STEP_CERTS_VERSION}/step-certificates_linux_${STEP_CERTS_VERSION}_amd64.tar.gz && \
